...
export default function NavMenu({ language, isActive }) {
  ...
  return (
    <nav
      ...
      } fixed z-[60] bg-white-transparent dark:bg-black-transparent w-full flex flex-col h-[40vh] py-[96px] px-[24px] lg:px-[48px] gap-[6px] lg:gap-[12px] items-center justify-center text-[36px] lg:text-[48px] text-center dark:text-secondary backdrop-blur-md rounded-md`}
    >
