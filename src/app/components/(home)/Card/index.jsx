...
export default function Card({ project }) {
  return (
    <Link href={project.link} className="sticky top-0 border-2 border-orange lg:top-[40vh] card-container  w-full h-[100vh] md:h-[500px]  flex items-center justify-center rounded-md overflow-hidden  ">
      <div
        style={{
        ...
        className="group w-full h-full object-cover rounded-lg relative flex px-[24px] py-[24px] uppercase"
      >
