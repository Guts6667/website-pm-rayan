...
export default function Card({ project }) {
  return (
    <Link href={project.link} className="sticky top-[48px] lg:top-[48px] card-container w-[100%] h-[100vh] lg:px-[72px] flex items-center justify-center rounded-md overflow-hidden pt-[120px] ">
      <div
        style={{
        ...
        className="group w-full h-[500px] lg:h-[700px] object-cover rounded-lg relative flex px-[24px] py-[24px] uppercase"
      >
