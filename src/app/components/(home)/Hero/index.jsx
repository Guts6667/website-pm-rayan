...
export default function Hero( ) {
  ...
  return (
    <section className={`light:bg-secondary dark:bg-primary min-h-[100vh] flex flex-col justify-center items-center gap-[6px] px-[24px] py-[48px] overflow-hidden z-10`}>
